...
export function AdminLogin() {
  ...
  const onFinish = (values:any) => {
    ...
    .then(data => {
      ...
      if(data == "User Found"){
        ...
        navigate('/adminProfile', { state: { email: values.email } });
      }
    })
    .catch((error) => {
  ...
  return (
    <div  style={{ backgroundImage: "url('../../../public/background.jpg')",backgroundSize: 'cover',
      backgroundPosition: 'center'}} className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-400 to-indigo-600">
